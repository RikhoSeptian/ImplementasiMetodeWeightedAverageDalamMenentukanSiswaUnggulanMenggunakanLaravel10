...
<head>
    ...
    <title>Login - SMP Karya Pembangunan Margahayu</title>
    ...
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #f5f5f5">
        ...
        <div class="content-4-1 d-flex flex-column align-items-center h-100 flex-lg-row"
            ...
            <div class="position-relative d-none d-lg-block h-100 width-left bg-primary">
                <img class="position-absolute img-fluid centered " src="{{ asset('img/logo.png') }}" alt="" style="width: 400px;" />
            </div>
            <div id="page" class="d-flex mx-0 align-items-left justify-content-left width-right mx-lg-0">
                <div class="right mx-lg-0 mx-auto">
                    <div class="align-items-center justify-content-center mb-3 pb-3 d-lg-none d-flex">
                        <img class="img-fluid rounded-circle" src="{{ asset('img/logo.png') }}" alt="" style="width: 200px;" />
                    </div>
                    ...
                    <form style="margin-top: 1.5rem" action="{{ route('login') }}" method="POST">
                        ...
                        <div style="margin-bottom: 1.75rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" value="{{ old('username') }}" type="text" name="username" id="username" placeholder="Masukkan username" autofocus required />
                            </div>
                        </div>
                        <div style="margin-top: 1rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="password" name="password" id="password" placeholder="Masukkan password" required />
