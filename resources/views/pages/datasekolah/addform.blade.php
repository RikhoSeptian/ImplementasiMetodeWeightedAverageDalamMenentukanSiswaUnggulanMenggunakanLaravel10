<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group row">
            <label for="nuptkkepsek" class="col-sm-4 col-form-label">NUPTK Kepala Sekolah</label>
            <div class="col-sm-8">
                <input type="number" value="{{ old('nuptkkepsek') }}" class="form-control @error('nuptkkepsek') is-invalid @enderror " name="nuptkkepsek" id="nuptkkepsek" placeholder="Masukkan nuptkkepsek">
                @error('nuptkkepsek')
                    <span class="invalid-feedback mt-1">
                        {{ $message }}
                    </span>
    ...
    <div class="col-md-6">
        ...
        <div class="offset-sm-6 col-sm-8 mt-2">
