...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <input type="number" value="{{ old('nuptkkepsek', $sekolah->nuptkkepsek) }}" class="form-control @error('nuptkkepsek') is-invalid @enderror " name="nuptkkepsek" id="nuptkkepsek" placeholder="Masukkan nuptkkepsek">
        @error('nuptkkepsek')
            <span class="invalid-feedback mt-1">
                {{ $message }}
            </span>
