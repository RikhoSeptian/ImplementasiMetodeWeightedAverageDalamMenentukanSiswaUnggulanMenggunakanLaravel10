                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button data-bs-toggle="modal" data-bs-target="#modalTambah" class="btn btn-sm float-left btn-primary btn-icon-split">
                                        ...
                                        <tbody>
                                            @foreach ($tapel as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{-- <button href="#" type="button" class="btn btn-success pb-1 pt-0 px-2" data-bs-toggle="modal" data-bs-target="#modalShow/{{ $item->id }}">
                                                        ...
                                                        <a href="{{ route('datatapel.edit', $item->id) }}" type="button" class=" btn btn-primary pb-1 pt-0 px-2">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form action="{{ route('datatapel.destroy', $item->id) }}" method="POST" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        beberapa siswa di Tahun Pelajaran <b> {{ $item->tahun_pelajaran }} - Semester {{ $item->semester == 1 ? 'Ganjil' : 'Genap' }} </b>
                                                                    </div>
                                                                    <div class="modal-footer">
        ...
        <div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <form action="{{ route('datatapel.store') }}" method="POST">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title fw-semibold poppins" id="exampleModalLabel">Tambah Data Tapel
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            @include('pages.datatapel.addform')
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
