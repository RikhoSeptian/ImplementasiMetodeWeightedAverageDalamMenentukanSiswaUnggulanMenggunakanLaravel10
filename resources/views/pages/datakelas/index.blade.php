                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @can('admin')
                                <a href="{{ route('datakelas.create', $role) }}" class="btn btn-sm float-left btn-primary btn-icon-split">
                                        ...
                                        <tbody>
                                            @foreach ($kelas as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('datakelas.show', ['datakela' => $item->id, 'role' => $role]) }}" class="btn btn-success pb-1 pt-0 px-2">
                                                        ...
                                                        @can('admin')
                                                            <a href="{{ route('datakelas.edit', ['datakela' => $item->id, 'role' => $role]) }}" type="button" class=" btn btn-primary pb-1 pt-0 px-2">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form action="{{ route('datakelas.destroy', ['datakela' => $item->id, 'role' => $role]) }}" method="POST" class="d-inline">
                                                                            @csrf
                                                                            @method('DELETE')
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        beberapa siswa di <b>Kelas - {{ $item->name }}</b>
                                                                    </div>
                                                                    <div class="modal-footer">
