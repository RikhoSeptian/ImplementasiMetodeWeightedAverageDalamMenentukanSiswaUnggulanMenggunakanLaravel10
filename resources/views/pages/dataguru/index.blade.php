                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('dataguru.create') }}" class="btn btn-sm float-left btn-primary btn-icon-split">
                            ...
                            {{-- <button class="btn btn-warning btn-sm float-right d-inline" data-bs-toggle="modal" data-bs-target="#importData">
                                Import Data
                            </button> --}}
                        </div>
                        <!-- /.card-header -->
                                            ...
                                            @foreach ($guru as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('dataguru.edit', $item->id) }}" type="button" class=" btn btn-primary pb-1 pt-0 px-2">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form action="{{ route('dataguru.destroy', $item->id) }}" method="POST" class="d-inline">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <input type="hidden" name="user_id" id="" value="{{ $item->user_id }}" hidden>
                                                                            <input type="hidden" name="name" id="" value="{{ $item->name }}" hidden>
                                                        ...
                                                        <div class="modal fade" id="modalShow/{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-md modal-dialog-scrollable">
                                                                <div class="modal-content">
                                                                            ...
                                                                            <table>
                                                                                <tr class="border-bottom">
                                                                                    <div class="text-center mb-3">
                                                                                        <img class="profile-user-img img-circle" src="/img/{{ $item->foto ?? 'default.jpg' }}" style="object-fit: fill" alt="User profile picture">
                                                                                    </div>
                                                                                </tr>
                                                                                <tr class="border-bottom">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <a href="{{ route('dataguru.edit', $item->id) }}" type="button" class=" btn btn-primary">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                                            </svg>
