                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('datamapel.create') }}" class="btn btn-sm float-left btn-primary btn-icon-split">
                                        ...
                                        <tbody>
                                            @foreach ($mapel as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->kelompok }}</td>
                                                    <td>
                                                        {{ $item->tapel->tahun_pelajaran }} - {{ $item->tapel->semester == 1 ? 'Ganjil' : 'Genap' }}
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('datamapel.show', $item->id) }}" class="btn btn-success pb-1 pt-0 px-2">
                                                        ...
                                                        <a href="{{ route('datamapel.edit', $item->id) }}" type="button" class=" btn btn-primary pb-1 pt-0 px-2">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form action="{{ route('datamapel.destroy', $item->id) }}" method="POST" class="d-inline">
                                                                            @csrf
                                                                            @method('DELETE')
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        Data tersebut tidak dapat dihapus! Karena terdapat beberapa pembelajaran pada 
                                                                        <b> Mapel - {{ $item->name }}</b>
                                                                    </div>
                                                                    <div class="modal-footer">
