                                        ...
                                        <tbody>
                                            @foreach ($pembelajaran as $item)
                                                <tr>
                                                    ...
                                                    <td> 
                                                        <b>{{ $item->mapel->name }}</b> - {{ $item->kelas->name }}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('datapembelajaran.show', ['role' => auth()->user()->role, 'datapembelajaran' => $item->id]) }}" class="btn btn-success pb-1 pt-0 px-2">
