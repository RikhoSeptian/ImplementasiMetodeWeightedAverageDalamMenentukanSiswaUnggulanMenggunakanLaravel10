...
<head>
    <meta charset="utf-8" />
    <title>CETAK RAPORT | {{ $siswa->name ? $siswa->name : '-' }} ({{ $siswa->nis ? $siswa->nis : '-' }})</title>
...
<body>
    ...
    <div class="invoice-box">
        ...
        <div style="text-align: center; padding-top: 150px;">
            ...
            <table>
                <tr>
                    ...
                    <td
                        style="width: 70%; border: 1px solid #333; height: 35px; text-align: center; font-size: 18px; text-transform: uppercase;">
                        <b>{{ $siswa->name ? $siswa->name : '-' }}</b></td>
                    <td style="width: 15%;"></td>
                </tr>
            </table>
        </div>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 60%; border: 1px solid #333; height: 35px; text-align: center; font-size: 18px;">
                        <b>{{ $siswa->nisn ? $siswa->nisn : '-' }} / {{ $siswa->nis ? $siswa->nis : '-' }}</b></td>
                    <td style="width: 20%;"></td>
                </tr>
            </table>
        </div>
        <div style="text-align: center; padding-top: 140px;">
            ...
            <p>
                ...
                TELP. (022) {{ $sekolah->telepon ? $sekolah->telepon : '-' }}
            </p>
        </div>
        <div class="footer">
            <i>{{ $siswa->name ? $siswa->name : '-' }} | {{ $siswa->nis ? $siswa->nis : '-' }}</i> <b style="float: right;"><i>i</i></b>
        </div>
    </div>
        ...
        <div style="padding-top: 15px;   font-size: 15px;">
            <table>
                <tr>
                    ...
                    <td style="width: 2%;">:</td>
                    <td style="width: 78%;">{{ $sekolah->name ? $sekolah->name : '-' }}</td>
                </tr>
                <tr style="line-height: 30px;">
                    <td style="width: 20%;">NPSN</td>
                    <td style="width: 2%;">:</td>
                    <td style="width: 78%;">{{ $sekolah->npsn ? $sekolah->npsn : '-' }}</td>
                </tr>
                <tr style="line-height: 30px;">
                    <td style="width: 20%;">NIS/NSS/NDS</td>
                    <td style="width: 2%;">:</td>
                    <td style="width: 78%;">{{ $sekolah->nss ? $sekolah->nss : '-' }}</td>
                </tr>
                <tr style="line-height: 30px;">
                    <td style="width: 20%;">Alamat</td>
                    <td style="width: 2%;">:</td>
                    <td style="width: 78%;">{{ $sekolah->alamat ? $sekolah->alamat : '-' }}</td>
                </tr>
                <tr style="line-height: 30px;">
                    <td style="width: 20%;">Kode Pos</td>
                    <td style="width: 2%;">:</td>
                    <td style="width: 78%;">{{ $sekolah->kodepos ? $sekolah->kodepos : '-' }}</td>
                </tr>
                <tr style="line-height: 30px;">
                    <td style="width: 20%;">Website</td>
                    <td style="width: 2%;">:</td>
                    <td style="width: 78%;">http://{{ $sekolah->website ? $sekolah->website : '-' }}</td>
                </tr>
                <tr style="line-height: 30px;">
                    <td style="width: 20%;">Email</td>
                    <td style="width: 2%;">:</td>
                    <td style="width: 78%;">{{ $sekolah->email ? $sekolah->email : '-' }}</td>
                </tr>
                <tr style="line-height: 30px;">
                    <td style="width: 20%;">Telepon</td>
                    <td style="width: 2%;">:</td>
                    <td style="width: 78%;">{{ $sekolah->telepon ? $sekolah->telepon : '-' }}</td>
                </tr>
            </table>
        </div>
        <div class="footer">
            <i>{{ $siswa->name ? $siswa->name : '-' }} | {{ $siswa->nis ? $siswa->nis : '-' }}</i>
            <b style="float: right;">
                <i>ii</i>
            </b>
        </div>
    ...
    <div class="invoice-box">
        <div style="text-align: center;">
            <h2>
                <strong>KETERANGAN TENTANG DIRI PESERTA DIDIK</strong>
            </h2>
        </div>
        <div style="padding-top: 15px; font-size: 15px;">
            <table>
                <tr>
                    ...
                    <td style="width: 2%;">:</td>
                    <td>{{ $siswa->name ? $siswa->name : '-' }}</td>
                </tr>
                <tr style="line-height: 25px;">
                    <td style="width: 4%;">2</td>
                    <td style="width: 25%;">Nomor Induk / NISN</td>
                    <td style="width: 2%;">:</td>
                    <td>{{ $siswa->nis ? $siswa->nis : '-' }} / {{ $siswa->nisn ? $siswa->nisn : '-' }}</td>
                </tr>
                <tr style="line-height: 25px;">
                    ...
                    <td style="width: 2%;">:</td>
                    <td>
                        {{ $siswa->tempatlahir && $siswa->tanggallahir ? $siswa->tempatlahir . ', ' . Carbon::createFromFormat('Y-m-d', $siswa->tanggallahir)->locale('id')->isoFormat('D MMMM YYYY') : '-' }}
                    </td>
                </tr>
                <tr style="line-height: 25px;">
                ...
                <tr style="line-height: 25px;">
                    ...
                    <td style="width: 2%;">:</td>
                    <td>{{ $siswa->anak_ke ? $siswa->anak_ke : '-' }}</td>
                </tr>
                <tr style="line-height: 25px;">
                ...
                <tr style="line-height: 25px;">
                    ...
                    <td style="width: 2%;">:</td>
                    <td>{{ $siswa->telepon ? $siswa->telepon : '-' }}</td>
                </tr>
                <tr style="line-height: 25px;">
                    <td style="width: 4%;">10</td>
                    <td style="width: 25%;">Diterima di sekolah ini</td>
                    <td style="width: 2%;"></td>
                    <td>{{ $siswa->diterimapada ? $siswa->diterimapada : '-' }}</td>
                </tr>
                <tr style="line-height: 25px;">
                    <td style="width: 4%;"></td>
                    <td style="width: 25%;">Di Kelas</td>
                    <td style="width: 2%;">:</td>
                    <td>{{ $siswa->kelas->name ? $siswa->kelas->name : '-' }}</td>
                </tr>
                <tr style="line-height: 25px;">
                    <td style="width: 4%;"></td>
                    ...
                    <td style="width: 2%;">:</td>
                    <td>
                        {{ $siswa->diterimapada ? Carbon::createFromFormat('Y-m-d', Str::before($siswa->diterimapada, ' '))->locale('id')->isoFormat('D MMMM YYYY') : '-' }}
                    </td>
                </tr>
                <tr style="line-height: 25px;">
                    <td style="width: 4%;"></td>
                ...
                <tr style="line-height: 25px;">
                    ...
                    <td style="width: 2%;">:</td>
                    <td>{{ $siswa->namaayah ? $siswa->namaayah : '-' }}</td>
                </tr>
                <tr style="line-height: 25px;">
                    <td style="width: 4%;"></td>
                    <td style="width: 25%;">b. Ibu</td>
                    <td style="width: 2%;">:</td>
                    <td>{{ $siswa->namaibu ? $siswa->namaibu : '-' }}</td>
                </tr>
                <tr style="line-height: 25px;">
                ...
                <tr style="line-height: 25px;">
                    ...
                    <td style="width: 25%;">a. Ayah</td>
                    <td style="width: 2%;">:</td>
                    <td>{{ $siswa->pekerjaanayah ? $siswa->pekerjaanayah : '-' }}</td>
                </tr>
                <tr style="line-height: 25px;">
                    <td style="width: 4%;"></td>
                    <td style="width: 25%;">b. Ibu</td>
                    <td style="width: 2%;">:</td>
                    <td>{{ $siswa->pekerjaanibu ? $siswa->pekerjaanibu : '-' }}</td>
                </tr>
                <tr style="line-height: 25px;">
                    <td style="width: 4%;">13</td>
                    <td style="width: 25%;">Nama Wali Siswa</td>
                    <td style="width: 2%;">:</td>
                    <td>{{ $siswa->namawali ? $siswa->namawali : '-' }}</td>
                </tr>
                <tr style="line-height: 25px;">
                    <td style="width: 4%;">14</td>
                    <td style="width: 25%;">Pekerjaan Wali Siswa</td>
                    <td style="width: 2%;">:</td>
                    <td>{{ $siswa->pekerjaanwali ? $siswa->pekerjaanwali : '-' }}</td>
                </tr>
            </table>
            <table style="padding-top: 30px;">
                <tr>
                    ...
                    <td style="width: 22%;">
                        <div
                            style="border: 1px solid #333; width: 25mm; height: 35mm; text-align: center; font-size: 12px;">
                            <br><br><br>
                            Foto Siswa <br>
                            3x4
                        </div>
                    ...
                    <td style="width: 40%; font-size: 15px;">
                        ...
                        @endif --}}
                        {{ $bagiraport->tempatbagiraport ?? 'Tempat' }},
                        {{ Carbon::createFromFormat('Y-m-d', Str::before($bagiraport->tanggalbagiraport, ' '))->locale('id')->isoFormat('D MMMM YYYY') ?? 'Tanggal' }},
                        <br>
                        Kepala Sekolah, <br><br><br><br>
                        <b><u>{{ $sekolah->kepsek ? $sekolah->kepsek : '-' }}</u></b><br>
                        NUPTK. {{ $sekolah->nuptkkepsek ? $sekolah->nuptkkepsek : '-' }}
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="invoice-box">
        <div class="header">
            <table>
                <tr>
                    ...
                    <td style="width: 52%;">: {{ $sekolah->name ? $sekolah->name : '-' }}</td>
                    <td style="width: 16%;">Kelas</td>
                    <td style="width: 13%;">: {{ $siswa->kelas->name ? $siswa->kelas->name : '-' }}</td>
                </tr>
                <tr>
                    <td style="width: 19%;">Alamat</td>
                    <td style="width: 52%;">: {{ $sekolah->alamat ? $sekolah->alamat : '-' }}</td>
                    <td style="width: 16%;">Semester</td>
                    <td style="width: 13%;">:
                        @if ($siswa->kelas->tapel->semester == 1)
                            1 (Ganjil)
                        @elseif ($siswa->kelas->tapel->semester == 2)
                            2 (Genap)
                        @else
                            -
                        @endif
                ...
                <tr>
                    ...
                    <td style="width: 52%;">: {{ $siswa->name ? $siswa->name : '-' }} </td>
                    <td style="width: 16%;">Tahun Pelajaran</td>
                    <td style="width: 13%;">: {{ $siswa->kelas->tapel->tahun_pelajaran ? $siswa->kelas->tapel->tahun_pelajaran : '-' }}</td>
                </tr>
                <tr>
                    <td style="width: 19%;">Nomor Induk/NISN</td>
                    <td style="width: 52%;">: {{ $siswa->nis ? $siswa->nis : '-' }} / {{ $siswa->nisn ? $siswa->nisn : '-' }} </td>
                </tr>
            </table>
        </div>
            ...
            <table cellspacing="0">
                ...
                <tr class="sikap">
                    @if ($nilai_spiritual)
                        ...
                        <td class="description">
                            <span>
                                {!! nl2br($nilai_spiritual->deskripsi ? $nilai_spiritual->deskripsi : '-') !!}
                            </span>
                        </td>
                    @else
                        <td></td>
                ...
                <tr class="sikap">
                    @if (!is_null($nilai_sosial))
                        ...
                        <td class="description">
                            <span>{{ $nilai_sosial->deskripsi ? $nilai_sosial->deskripsi : '-' }}</span>
                        </td>
                    @else
                        <td></td>
                        <td></td>
        ...
        <div
            ...
            <b><u>{{ $siswa->kelas->guru->name ? $siswa->kelas->guru->name : '-' }}, {{ $siswa->kelas->guru->gelar ? $siswa->kelas->guru->gelar : '' }}</u></b><br>
            NUPTK. {{ $siswa->kelas->guru->nuptk ? $siswa->kelas->guru->nuptk : '-' }}
        </div>
        <div class="footer">
            <i>{{ $siswa->kelas->name ? $siswa->kelas->name : '-' }} | {{ $siswa->name ? $siswa->name : '-' }} | {{ $siswa->nis ? $siswa->nis : '-' }}</i> <b
    ...
    <div class="invoice-box">
        ...
        <div class="content">
            <table cellspacing="0">
                ...
                <tr class="heading">
                    ...
                    <td rowspan="2" style="width: 25%;">Mata Pelajaran</td>
                ...
                @foreach ($nilaiakhirs as $nilaiakhir)
                    @if ($nilaiakhir->pembelajaran->mapel->kelompok == 'A')
                        ...
                        <tr class="nilai">
                            ...
                            <td class="description">
                                <span>
                                    {!! nl2br($nilaiakhir->deskripsi ? $nilaiakhir->deskripsi : '-') !!}
                                </span>
                            </td>
                        </tr>
                    @endif
        ...
        <div class="footer">
            <i>{{ $siswa->kelas->name ? $siswa->kelas->name : '-' }} | {{ $siswa->name ? $siswa->name : '-' }} | {{ $siswa->nis ? $siswa->nis : '-' }}</i> 
            <b style="float: right;">
                <i>Halaman 2</i>
            </b>
        </div>
                ...
                @elseif(count($anggotaekskul) == 1)
                    ...
                    @foreach ($anggotaekskul as $item)
                        ...
                        <tr class="nilai">
                            <td class="center">{{ $no }}</td>
                            <td>
                                {{ $item->ekstrakurikuler->name ? $item->ekstrakurikuler->name : '-' }}
                            </td>
                            <td colspan="2" class="description">
                                <span>
                                    @if ($item->predikat == 'A')
                ...
                @elseif(count($prestasisiswa) == 1)
                    ...
                    @foreach ($prestasisiswa as $prestasi)
                        ...
                        <tr class="nilai">
                            ...
                            <td colspan="2" class="description">
                                <span>{!! nl2br($prestasi->keterangan ? $prestasi->keterangan : '-') !!}</span>
                            </td>
                        </tr>
                    @endforeach
                    <tr class="nilai">
                ...
                <tr class="sikap">
                    <td colspan="4" class="description" style="height: 50px;">
                        @if (!is_null($catatan_wali_kelas))
                            <i><b>{{ $catatan_wali_kelas->catatan ? $catatan_wali_kelas->catatan : '-' }}</b></i>
                        @endif
                    </td>
                </tr>
