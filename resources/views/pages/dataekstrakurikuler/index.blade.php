...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0">Data Ekstrakurikuler @can('pembina')
                            Saya
                        @endcan
                    </h1>
                </div>
                                            ...
                                            @foreach ($ekskul as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @can('admin')
                                                            <button data-bs-target="#modalEdit/{{ $item->id }}" data-bs-toggle="modal" type="button" class=" btn btn-primary pb-1 pt-0 px-2">
                                                        ...
                                                        <div class="modal fade" id="modalEdit/{{ $item->id }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                ...
                                                                <form
                                                                    action="{{ route('dataekstrakurikuler.update', ['dataekstrakurikuler' => $item->id, 'role' => $role]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            @include('pages.dataekstrakurikuler.editform')
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="submit"
        ...
        <div class="modal-dialog">
            ...
            <form action="{{ route('dataekstrakurikuler.store', ['role' => $role]) }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        @include('pages.dataekstrakurikuler.addform')
                    </div>
                    <div class="modal-footer">
